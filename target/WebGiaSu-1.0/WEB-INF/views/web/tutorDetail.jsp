		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="tutor-info">
					...
					<p>
						<strong>Bio:</strong>
						<c:out value="${model.bio}" />
					</p>
					<p>
						<strong>Chuyên môn:</strong>
						<c:out value="${model.specialization}" />
					</p>
					<p>
						<strong>Trình độ học vấn:</strong>
						<c:out value="${model.education}" />
					</p>
					<p>
						<strong>Kinh Nghiệm:</strong>
						<c:out value="${model.experience}" />
					</p>
					<p>
						<strong>Giá thuê:</strong>
						<c:out value="${model.hourlyRate}" />
					</p>
					<p>
						<strong>Thời gian:</strong>
						<c:out value="${model.availableTimes}" />
					</p>
				</div>
